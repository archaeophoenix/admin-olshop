...
<head>
  ...
  <link href="<?php echo $base_url; ?>css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="all">
  <link href="<?php echo $base_url; ?>css/jquery-ui.css" rel="stylesheet" media="all">

  <!-- Main CSS-->
  <link href="<?php echo $base_url; ?>css/theme.css" rel="stylesheet" media="all">
  <style type="text/css">
    .btn,.form-input,.select2-selection{border-radius: 50px;}
    .btn-nav{height: 35px;width: 35px;}
  </style>
        ...
        <div class="container-fluid">
          <ul class="navbar-mobile__list list-unstyled">
            <?php foreach ($menu as $key => $val) { ?>
              <li class="has-sub <?php echo (($route == ('/' . $val['url'])) || ($route == ('/' . $val['url'] . '-form'))) ? 'active' : '';?>">
                <a href="<?php echo $base_url . $val['url']; ?>"><i class="fas <?php echo $val['icon']; ?>"></i><?php echo $val['title']; ?></a>
              </li>
            <?php } ?>
          </ul>
        </div>
